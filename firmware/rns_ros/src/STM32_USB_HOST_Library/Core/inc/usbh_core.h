...
/* Includes ------------------------------------------------------------------*/
#include "STM32_USB_OTG_Driver/inc/usb_hcd.h"
#include "STM32_USB_HOST_Library/Core/inc/usbh_def.h"
#include "STM32_USB_HOST_Library/Core/inc/usbh_conf.h"
...
#define USB_PHYSICAL						  0x05  /* Physical */
#define USB_IMAGE						      0x06  /* Image */
#define USB_WIRELESS_CONTROLLER				  0xE0  /* Wireless Controller */
#define USB_CONTENT_SECURITY			  	  0x0D	/* Content Security */
#define USB_PERSONAL_HEALTH					  0x0F	/* Personal Healthcare */
#define USB_DIAGNOSTIC_DEVICE				  0xDC	/* Diagnostic Device */
#define USB_MISC				 			  0xEF	/* Miscellaneous */
#define USB_APP_SPECIFIC					  0xFE	/* Application Specific */
#define USB_VENDOR_SPECIFIC					  0xFF	/* Vendor Specific */
