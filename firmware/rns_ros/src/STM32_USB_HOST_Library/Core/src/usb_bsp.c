...
#define HOST_OVRCURR_LINE                  GPIO_Pin_15
#define HOST_OVRCURR_PORT_SOURCE           GPIO_PortSourceGPIOD
#define HOST_OVRCURR_PIN_SOURCE            GPIO_PinSource15
#define HOST_OVRCURR_PORT_RCC              RCC_APB1Periph_GPIOD
#define HOST_OVRCURR_EXTI_LINE             EXTI_Line15
